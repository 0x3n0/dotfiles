...
static const int topbar            = 9;   /* 0 means bottom bar */
 ...
 */
static const char *fonts[]     = {"fontawesome:size=10", "SauceCodePro Mono:weight=bold:size=9:antialias=true:autohint=true","SymbolsNerdFont:size=15:antialias=true:autohint=true","NotoColorEmoji:size=11:antialias=true:autohint=true"};
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,      -1,        XK_t,      spawn,          CMD("telegram") },
